...
class SurveyLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const SurveyLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(surveyLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/survey/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<SurveyLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
