...
class SurveyFileDetailPage extends ConsumerWidget {
  final String id;
  const SurveyFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(surveyFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/survey/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<SurveyFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
