...
class SurveyModuleTeamMemberDetailPage extends ConsumerWidget {
  final String id;
  const SurveyModuleTeamMemberDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(surveyModuleTeamMemberDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/survey/module-team-members/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<SurveyModuleTeamMember>(
        value: itemAsync,
        data: (item) {
          return ListView(
