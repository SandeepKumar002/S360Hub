...
class SurveyModuleRoleAssignmentDetailPage extends ConsumerWidget {
  final String id;
  const SurveyModuleRoleAssignmentDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(surveyModuleRoleAssignmentDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/survey/module-role-assignments/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<SurveyModuleRoleAssignment>(
        value: itemAsync,
        data: (item) {
          return ListView(
