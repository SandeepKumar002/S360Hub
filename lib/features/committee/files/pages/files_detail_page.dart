...
class CommitteeFileDetailPage extends ConsumerWidget {
  final String id;
  const CommitteeFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(committeeFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/committee/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<CommitteeFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
