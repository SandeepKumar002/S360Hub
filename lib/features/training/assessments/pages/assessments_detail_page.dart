...
class TrainingAssessmentDetailPage extends ConsumerWidget {
  final String id;
  const TrainingAssessmentDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(trainingAssessmentDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/training/assessments/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<TrainingAssessment>(
        value: itemAsync,
        data: (item) {
          return ListView(
            ...
            children: [
              ...
              ListTile(title: Text('PassingScore'), subtitle: Text(item.passingScore.toString())),
