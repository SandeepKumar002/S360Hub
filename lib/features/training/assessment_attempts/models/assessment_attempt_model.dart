class TrainingAssessmentAttempt {
  final String id;
  ...
  factory TrainingAssessmentAttempt.fromJson(Map<String, dynamic> json) {
    return TrainingAssessmentAttempt(
      id: json['id'] as String,
      assessmentId: json['assessment_id'] as String?,
      employeeId: json['employee_id'] as String?,
      attemptDate: json['attempt_date'] == null ? null : DateTime.parse(json['attempt_date'] as String),
