...
class TrainingLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const TrainingLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(trainingLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/training/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<TrainingLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
