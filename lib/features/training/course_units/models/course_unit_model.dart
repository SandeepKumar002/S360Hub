class TrainingCourseUnit {
  ...
  factory TrainingCourseUnit.fromJson(Map<String, dynamic> json) {
    return TrainingCourseUnit(
      id: json['id'] as String,
      courseId: json['course_id'] as String?,
      title: json['title'] as String?,
      contentRefId: json['content_ref_id'] as String?,
