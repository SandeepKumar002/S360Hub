...
class TrainingModuleTeamMemberDetailPage extends ConsumerWidget {
  final String id;
  const TrainingModuleTeamMemberDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(trainingModuleTeamMemberDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/training/module-team-members/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<TrainingModuleTeamMember>(
        value: itemAsync,
        data: (item) {
          return ListView(
