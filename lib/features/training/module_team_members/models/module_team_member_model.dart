class TrainingModuleTeamMember {
  final String id;
  final String? orgId;
  final String? teamId;
  ...
  factory TrainingModuleTeamMember.fromJson(Map<String, dynamic> json) {
    return TrainingModuleTeamMember(
