...
class LedgieLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const LedgieLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(ledgieLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/ledgie/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<LedgieLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
