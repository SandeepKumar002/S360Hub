...
class LedgieModuleRoleDetailPage extends ConsumerWidget {
  final String id;
  const LedgieModuleRoleDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(ledgieModuleRoleDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/ledgie/module-roles/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<LedgieModuleRole>(
        value: itemAsync,
        data: (item) {
          return ListView(
