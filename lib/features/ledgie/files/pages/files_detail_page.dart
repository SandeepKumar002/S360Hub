...
class LedgieFileDetailPage extends ConsumerWidget {
  final String id;
  const LedgieFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(ledgieFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/ledgie/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<LedgieFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
