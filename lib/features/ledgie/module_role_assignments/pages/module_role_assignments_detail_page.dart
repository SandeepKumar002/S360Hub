...
class LedgieModuleRoleAssignmentDetailPage extends ConsumerWidget {
  final String id;
  const LedgieModuleRoleAssignmentDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(ledgieModuleRoleAssignmentDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/ledgie/module-role-assignments/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<LedgieModuleRoleAssignment>(
        value: itemAsync,
        data: (item) {
          return ListView(
