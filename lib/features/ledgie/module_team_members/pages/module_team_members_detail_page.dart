...
class LedgieModuleTeamMemberDetailPage extends ConsumerWidget {
  final String id;
  const LedgieModuleTeamMemberDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(ledgieModuleTeamMemberDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/ledgie/module-team-members/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<LedgieModuleTeamMember>(
        value: itemAsync,
        data: (item) {
          return ListView(
