...
class KnowledgeFileDetailPage extends ConsumerWidget {
  final String id;
  const KnowledgeFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(knowledgeFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/knowledge/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<KnowledgeFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
