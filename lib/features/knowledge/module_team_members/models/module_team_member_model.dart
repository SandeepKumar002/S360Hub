class KnowledgeModuleTeamMember {
  final String id;
  final String? orgId;
  final String? teamId;
  ...
  factory KnowledgeModuleTeamMember.fromJson(Map<String, dynamic> json) {
    return KnowledgeModuleTeamMember(
