...
class KnowledgeModuleRoleAssignmentDetailPage extends ConsumerWidget {
  final String id;
  const KnowledgeModuleRoleAssignmentDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(knowledgeModuleRoleAssignmentDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/knowledge/module-role-assignments/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<KnowledgeModuleRoleAssignment>(
        value: itemAsync,
        data: (item) {
          return ListView(
