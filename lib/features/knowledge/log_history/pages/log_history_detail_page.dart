...
class KnowledgeLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const KnowledgeLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(knowledgeLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/knowledge/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<KnowledgeLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
