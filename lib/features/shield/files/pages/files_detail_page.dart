...
class ShieldFileDetailPage extends ConsumerWidget {
  final String id;
  const ShieldFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(shieldFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/shield/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<ShieldFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
