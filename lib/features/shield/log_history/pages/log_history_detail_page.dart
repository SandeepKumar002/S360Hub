...
class ShieldLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const ShieldLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(shieldLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/shield/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<ShieldLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
