...
class CommFileDetailPage extends ConsumerWidget {
  final String id;
  const CommFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(commFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/comm/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<CommFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
