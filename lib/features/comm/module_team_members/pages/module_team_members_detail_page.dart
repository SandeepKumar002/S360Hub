...
class CommModuleTeamMemberDetailPage extends ConsumerWidget {
  final String id;
  const CommModuleTeamMemberDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(commModuleTeamMemberDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/comm/module-team-members/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<CommModuleTeamMember>(
        value: itemAsync,
        data: (item) {
          return ListView(
