...
class CommModuleRoleAssignmentDetailPage extends ConsumerWidget {
  final String id;
  const CommModuleRoleAssignmentDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(commModuleRoleAssignmentDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/comm/module-role-assignments/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<CommModuleRoleAssignment>(
        value: itemAsync,
        data: (item) {
          return ListView(
