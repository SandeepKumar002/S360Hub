...
class CommLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const CommLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(commLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/comm/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<CommLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
