...
class ContracforceLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const ContracforceLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(contracforceLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/contracforce/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<ContracforceLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
