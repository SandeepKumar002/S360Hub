...
class ContracforceFileDetailPage extends ConsumerWidget {
  final String id;
  const ContracforceFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(contracforceFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/contracforce/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<ContracforceFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
