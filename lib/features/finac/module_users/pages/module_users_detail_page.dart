...
class FinacModuleUserDetailPage extends ConsumerWidget {
  final String id;
  const FinacModuleUserDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(finacModuleUserDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/finac/module-users/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<FinacModuleUser>(
        value: itemAsync,
        data: (item) {
          return ListView(
