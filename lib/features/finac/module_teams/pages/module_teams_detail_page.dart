...
class FinacModuleTeamDetailPage extends ConsumerWidget {
  final String id;
  const FinacModuleTeamDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(finacModuleTeamDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/finac/module-teams/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<FinacModuleTeam>(
        value: itemAsync,
        data: (item) {
          return ListView(
