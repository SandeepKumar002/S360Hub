...
class FinacLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const FinacLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(finacLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/finac/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<FinacLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
