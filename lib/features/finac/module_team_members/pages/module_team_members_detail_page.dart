...
class FinacModuleTeamMemberDetailPage extends ConsumerWidget {
  final String id;
  const FinacModuleTeamMemberDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(finacModuleTeamMemberDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/finac/module-team-members/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<FinacModuleTeamMember>(
        value: itemAsync,
        data: (item) {
          return ListView(
