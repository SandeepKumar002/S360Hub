class FinacModuleRoleAssignment {
  final String id;
  final String? roleId;
  ...
  factory FinacModuleRoleAssignment.fromJson(Map<String, dynamic> json) {
    return FinacModuleRoleAssignment(
