...
class FinacModuleRoleAssignmentDetailPage extends ConsumerWidget {
  final String id;
  const FinacModuleRoleAssignmentDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(finacModuleRoleAssignmentDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/finac/module-role-assignments/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<FinacModuleRoleAssignment>(
        value: itemAsync,
        data: (item) {
          return ListView(
