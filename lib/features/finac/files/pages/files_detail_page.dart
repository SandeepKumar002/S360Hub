...
class FinacFileDetailPage extends ConsumerWidget {
  final String id;
  const FinacFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(finacFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/finac/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<FinacFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
