...
class TaxforgeLogHistoryDetailPage extends ConsumerWidget {
  final String id;
  const TaxforgeLogHistoryDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(taxforgeLogHistoryDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/taxforge/log-history/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<TaxforgeLogHistory>(
        value: itemAsync,
        data: (item) {
          return ListView(
