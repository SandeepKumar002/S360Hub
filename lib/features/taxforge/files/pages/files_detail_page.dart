...
class TaxforgeFileDetailPage extends ConsumerWidget {
  final String id;
  const TaxforgeFileDetailPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final itemAsync = ref.watch(taxforgeFileDetailProvider(id));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/taxforge/files/$id/edit'),
          ),
        ],
      ),
      body: AsyncValueWidget<TaxforgeFile>(
        value: itemAsync,
        data: (item) {
          return ListView(
